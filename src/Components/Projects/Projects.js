        ...
        >
          <SwiperSlide>
            <div className="project-card">
              ...
              <h3>Mario Game</h3>
              <p>
                A classic Mario game developed using HTML, CSS, and JavaScript.
                It includes various challenges to create an engaging user
                experience.
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="project-card">
              ...
              <p>
                ...
                data fetching scripts and environment variable configuration for
          ...
          <SwiperSlide>
            <div className="project-card">
              ...
              <p>
                ...
                contemporary user interface that enhances usability and provides
                a polished look.
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="project-card">
              ...
              <h3>Quiz App</h3>
              <p>
                Developed a dynamic web quiz with randomized questions and timed
                challenges for engaging user experiences. Implemented progress
                tracking, instant scoring, and an interactive frontend with
                JavaScript, HTML, and CSS for seamless usability.
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="project-card">
              ...
              <p>
                ...
                efficient handling of vehicle service records and customer data.
                Implemented CRUD operations for comprehensive patient detail
                handling
              </p>
            </div>
          </SwiperSlide>
